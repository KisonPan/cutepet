...
import com.kisonpan.samples.apps.cutepet.utilities.chooser
...
class PetDetailFragmentTest {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<MainActivity>()

    @Before
    fun jumpToPetDetailFragment() {
        composeTestRule.activityRule.scenario.onActivity {
            val bundle = Bundle().apply { putString("plantId", "malus-pumila") }
            findNavController(it, R.id.nav_host).navigate(R.id.pet_detail_fragment, bundle)
        }
    }
