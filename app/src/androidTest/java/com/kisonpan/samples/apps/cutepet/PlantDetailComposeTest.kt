...
import com.kisonpan.samples.apps.cutepet.compose.PetDetail.PetDetails
import com.kisonpan.samples.apps.cutepet.compose.PetDetail.PetDetailsCallbacks
import com.kisonpan.samples.apps.cutepet.data.Plant
import com.kisonpan.samples.apps.cutepet.test.R
...
class PetDetailComposeTest {
    ...
    @Test
    fun PetDetails_checkIsNotPlanted() {
        startPetDetails(isPlanted = false)
        composeTestRule.onNodeWithText("Apple").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Add plant").assertIsDisplayed()
    }

    @Test
    fun PetDetails_checkIsPlanted() {
        startPetDetails(isPlanted = true)
        composeTestRule.onNodeWithText("Apple").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Add plant").assertDoesNotExist()
    }

    private fun startPetDetails(isPlanted: Boolean) {
